...
import 'package:medicoo/NetWork/Models/login_model_user.dart';
...
import 'package:medicoo/UI/Screens/login_employee.dart';
                ...
                if (response) {
                  ...
                  if (Logintype == "manger") {
                    Navigator.push(context,
                      ...
                      return Controller_pharmcy();
                    }));
                    // ignore: unrelated_type_equality_checks
                  } else if (Logintype == "user") {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) {
                      return Home_User_Screen();
                    }));
                  }
                } else {
                  loginError = true;
