...
class DatabaseHelper {
 ...
 class GET_USER{
   ...
   Future<List<User_Data>> get_Data_user() async {
     String myUrl = base_api + getuser;
...
for (var item in jsondata['data']){
  ...
  data.add(User_Data.fromJson(item));
